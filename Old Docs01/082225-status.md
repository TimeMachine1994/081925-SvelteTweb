...
*   **Specialized Registration Flows**:
    *   The application now offers distinct registration paths to cater to different user roles:
        ...
        *   A streamlined page for loved ones at `/register/new-event-and-account`.
...
New components have been introduced to allow users to personalize event tributes with photos.

*   **Photo Uploading**: The `PhotoUploader.svelte` component provides an interface for users to upload images to a specific event.
...
*   **Created**:
    ...
    *   `frontend/src/routes/register/new-event-and-account/+page.svelte`: New registration page for loved ones.
