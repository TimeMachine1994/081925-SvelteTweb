...
- **View All Memorials**: Access to every event regardless of ownership
- **Event Analytics**: Usage statistics, engagement metrics
- **Content Moderation**: Review and moderate event content
- **Transfer Ownership**: Reassign event ownership
- **Archive/Restore**: Manage event lifecycle
...
- **Event Statistics**: Creation rates, engagement metrics
...
| Edit Any Event | ✅ | Own Only | Assigned Only | Invited Only | ❌ |
