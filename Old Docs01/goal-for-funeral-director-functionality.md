...
4.  **Family & Event Details:** The director fills in the details for the family and the event:
    *   Loved one's name.
    *   Family contact name.
    *   Family contact email (this will be used to create the family member's account).
    *   Event service details (date, time, location).
5.  **Submission:** The director submits the form.
6.  **Backend Processing:**
    *   A new user account is created for the family member.
    *   A new event document is created in Firestore.
    *   The logged-in funeral director is automatically assigned as the manager/organizer for this new event, granting them administrative privileges.
7.  **Confirmation & Link Sharing:** After successful submission, the funeral director is shown a confirmation message that includes the unique, shareable link to the newly created event page.
...
This workflow ensures that the funeral director who initiates the registration is always the one who manages the event, creating a clear and direct link between the director and the families they serve.
