	...
	_: {
		...
		routes: [
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/admin/settings/staff-password/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/admin/staff-codes/_server.ts.js'))
			},
			{
				...
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/admin/staff-codes/_id_/_server.ts.js'))
			},
			{
				id: "/api/admin/stats",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/admin/test-cleanup/_server.ts.js'))
			},
			{
				id: "/api/auth/login",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/auth/register-staff/_server.ts.js'))
			},
			{
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/auth/user/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/auth/verify-staff-password/_server.ts.js'))
			},
			{
				id: "/api/cases",
				pattern: /^\/api\/cases\/?$/,
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cases/_id_/_server.ts.js'))
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/cases/_id_/staff/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/consultations/_server.ts.js'))
			},
			{
				id: "/api/documents",
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/documents/upload/_server.ts.js'))
			},
			{
				id: "/api/documents/[id]",
				pattern: /^\/api\/documents\/([^/]+?)\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/files/delete/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/files/download/_server.ts.js'))
			},
			{
				id: "/api/files/list",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/files/list/_server.ts.js'))
			},
			{
				id: "/api/files/upload",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/files/upload/_server.ts.js'))
			},
			{
				id: "/api/invoices",
			...
			},
			{
				...
				params: [{"name":"id","optional":false,"rest":false,"chained":false}],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/invoices/_id_/pay/_server.ts.js'))
			},
			{
				id: "/api/messages",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/messages/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/messages/mark-read/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/messages/poll/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/messages/send/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/messages/unread/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/schedule/availability/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/schedule/book/_server.ts.js'))
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/square/create-payment-link/_server.ts.js'))
			},
			{
				id: "/api/staff/cases",
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/staff/cases/_server.ts.js'))
			},
			{
				id: "/api/users",
				pattern: /^\/api\/users\/?$/,
			...
			},
			{
				...
				params: [],
				page: null,
				endpoint: __memo(() => import('./entries/endpoints/api/users/staff/_server.ts.js'))
			},
			{
				id: "/contact",
				pattern: /^\/contact\/?$/,
