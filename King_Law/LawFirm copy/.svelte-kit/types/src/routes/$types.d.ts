...
type LayoutRouteId = RouteId | "/" | "/about" | "/contact" | "/dashboard/client" | "/dashboard/client/case/[id]" | "/dashboard/lawyer" | "/dashboard/lawyer/case/[id]" | "/dashboard/lawyer/client/[id]" | "/demo" | "/demo/lucia" | "/demo/lucia/login" | "/login" | "/register" | "/services/business-intellectual-property" | "/services/criminal-defense" | "/services/family-estate-law" | "/services/personal-injury" | null
