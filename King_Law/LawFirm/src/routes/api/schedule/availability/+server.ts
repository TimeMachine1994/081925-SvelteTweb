...
import { getAvailableSlots } from '$lib/server/google-calendar';
...
export const GET: RequestHandler = async ({ url }) => {
	...
	try {
		...
		const gaxErr = err as { response?: { data?: { error?: { message?: string; code?: number; errors?: unknown[] } } }; message?: string };
