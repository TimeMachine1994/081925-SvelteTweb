<script lang="ts">
	...
	const faqs = [
		{
			q: 'Who is the Fortress Package designed for?',
			a: 'High-net-worth individuals and families managing multiple legal matters simultaneously — whether it\'s estate planning, real estate, employment contracts, business entities, family transitions, or dispute management. If you have more than two active or anticipated legal needs, Fortress was built for you.'
		},
		{
			q: 'Why is enrollment limited?',
			a: 'Because we refuse to dilute the quality of service. Each Fortress member receives direct attorney access, proactive quarterly reviews, and rapid-response coordination. Limiting enrollment ensures every member gets the white-glove experience they\'re paying for.'
		},
		{
			q: 'What happens during the Legal Audit?',
			a: 'Within the first week of enrollment, we conduct a comprehensive 90-minute Legal Balance Sheet intake covering every asset, entity, contract, beneficiary designation, and open or potential dispute. You\'ll receive a written Risk Map and Roadmap within 10 business days — identifying what\'s urgent, what\'s important, and what can wait.'
		},
		{
			q: 'What is the Evidence Bank?',
			a: 'Within the first 72 hours, if any of your matters warrant video documentation — witness statements, property conditions, incident reconstructions — our team mobilizes to record and preserve that evidence. This becomes part of your permanent case file and is included in the Fortress fee.'
		},
		{
			q: 'Does Fortress cover trial?',
			a: 'Yes. Your annual membership includes pre-trial preparation and one trial. If multiple trials arise, we coordinate strategy and provide preferred-rate representation for additional proceedings.'
		},
		{
			q: 'Can I cancel?',
			a: 'Fortress is an annual commitment billed at enrollment. We invest significant resources upfront — the legal audit, evidence bank, and onboarding — so annual commitment ensures alignment between our investment in you and yours in us.'
		},
		{
			q: 'How do I know if I qualify?',
			a: 'Apply below. We\'ll schedule a confidential conversation to understand your situation. Fortress isn\'t for everyone — it\'s for people whose lives and assets are complex enough that fragmented legal counsel creates real risk.'
		}
	];
</script>

<svelte:head>
	<title>King's Fortress Package — King Law, PLLC</title>
	<meta name="description" content="The King's Fortress Package: An exclusive, limited-enrollment annual legal membership for high-net-worth individuals managing multiple legal matters. $20,000/year. Legal audit, monthly counsel, pre-trial work, and a trial included." />
</svelte:head>

<div class="min-h-screen pt-20">
	<!-- Hero Section -->
	<section class="min-h-[90vh] flex items-center relative overflow-hidden bg-king-blue-dark">
		<div class="absolute inset-0 bg-gradient-to-br from-king-blue-dark via-king-blue to-king-blue-dark"></div>
		<!-- Subtle pattern overlay -->
		<div class="absolute inset-0 opacity-5 fortress-pattern"></div>

		<div class="relative z-10 max-w-5xl mx-auto px-6 lg:px-8 py-24 text-center">
			<div class="bg-king-blue-dark/80 backdrop-blur-md border border-white/10 rounded-3xl px-8 py-14 md:px-14 md:py-16 depth-dark-3">
				<div class="inline-flex items-center gap-2 bg-gold/10 border border-gold/30 rounded-full px-5 py-2 mb-8">
					<span class="w-2 h-2 bg-gold rounded-full animate-pulse"></span>
					<span class="text-gold text-sm font-semibold tracking-wide uppercase">Limited Enrollment — Apply Now</span>
				</div>

				<h1 class="font-title text-5xl sm:text-6xl md:text-7xl lg:text-8xl text-white leading-[1.05] mb-6">
					The King's<br/>
					<span class="text-gold">Fortress</span>
				</h1>

				<p class="text-xl md:text-2xl text-white/80 max-w-3xl mx-auto mb-4 leading-relaxed">
					One attorney. One strategy. Every legal matter — handled.
				</p>
				<p class="text-lg text-white/55 max-w-2xl mx-auto mb-12">
					An exclusive annual legal membership for high-net-worth individuals who refuse to let fragmented counsel put their assets, reputation, and family at risk.
				</p>
				...
				<div class="flex flex-col sm:flex-row gap-4 justify-center mb-14">
					...
					<a href="#how-it-works" class="border-2 border-white/20 hover:border-gold text-white px-8 py-4 rounded-lg font-semibold transition-all duration-200 depth-ghost">
						See What's Included
					</a>
				</div>

				<!-- Key stats -->
				<div class="grid grid-cols-3 gap-4 md:gap-8 max-w-2xl mx-auto border-t border-white/10 pt-10">
					<div>
						<p class="text-gold font-title text-3xl md:text-4xl">$20K</p>
						<p class="text-white/50 text-sm mt-1">Per Year</p>
					</div>
					<div>
						<p class="text-gold font-title text-3xl md:text-4xl">1</p>
						<p class="text-white/50 text-sm mt-1">Trial Included</p>
					</div>
					<div>
						<p class="text-gold font-title text-3xl md:text-4xl">72hr</p>
						<p class="text-white/50 text-sm mt-1">Evidence Response</p>
					</div>
				</div>
			</div>
		</div>
	...
	<section id="how-it-works" class="py-24 bg-king-blue">
		<div class="max-w-5xl mx-auto px-6 lg:px-8">
			<p class="text-gold uppercase tracking-[0.3em] text-sm mb-4">How It Works</p>
			<h2 class="font-title text-4xl md:text-5xl text-white mb-16">From Application to Full Protection</h2>

			<div class="grid md:grid-cols-2 gap-4 md:gap-6">
				<div class="bg-white/8 border border-white/10 rounded-2xl p-5 md:p-8 depth-card-dark">
					<span class="inline-block text-gold font-bold text-sm tracking-widest mb-4">STEP 01</span>
					<h3 class="font-title text-2xl text-white mb-3">Apply</h3>
					<p class="text-white/60 leading-relaxed">Submit your application below. We'll schedule a confidential conversation to understand your situation and determine if Fortress is the right fit. Enrollment is limited — we accept only a small number of members each year.</p>
				</div>

				<div class="bg-white/8 border border-white/10 rounded-2xl p-5 md:p-8 depth-card-dark">
					<span class="inline-block text-gold font-bold text-sm tracking-widest mb-4">STEP 02</span>
					<h3 class="font-title text-2xl text-white mb-3">Legal Audit</h3>
					<p class="text-white/60 leading-relaxed">Within the first week, we conduct your comprehensive Legal Balance Sheet intake — a deep-dive into every asset, entity, title, beneficiary, contract, and dispute. You'll receive a prioritized Risk Map and Roadmap: what's urgent, what's important, and what can wait.</p>
				</div>

				<div class="bg-white/8 border border-white/10 rounded-2xl p-5 md:p-8 depth-card-dark">
					<span class="inline-block text-gold font-bold text-sm tracking-widest mb-4">STEP 03</span>
					<h3 class="font-title text-2xl text-white mb-3">Evidence Bank</h3>
					<p class="text-white/60 leading-relaxed">Within 72 hours, if any matter requires video preservation — witness statements, property conditions, scene documentation — our team is deployed. This evidence bank is secured and becomes part of your permanent case file, at no additional cost.</p>
				</div>

				<div class="bg-white/8 border border-white/10 rounded-2xl p-5 md:p-8 depth-card-dark">
					<span class="inline-block text-gold font-bold text-sm tracking-widest mb-4">STEP 04</span>
					<h3 class="font-title text-2xl text-white mb-3">Ongoing Protection</h3>
					<p class="text-white/60 leading-relaxed">Monthly counsel, quarterly governance reviews, annual estate and beneficiary audits, and rapid-response for any new issue. Pre-trial work runs continuously on active matters, and when it's time for court — your trial is included.</p>
				</div>
			</div>
		</div>
	</section>
	...
	<section class="py-24 bg-white">
		<div class="max-w-5xl mx-auto px-6 lg:px-8">
			...
			<div class="grid lg:grid-cols-2 gap-8 items-start">
				...
				<div class="bg-gray-50 rounded-3xl border border-gray-100 overflow-hidden depth-card">
					<div class="bg-king-blue p-8 text-center">
						...
						<div class="flex items-baseline justify-center gap-2">
							<span class="text-white font-title text-4xl md:text-5xl">$20,000</span>
							<span class="text-white/50 text-lg">/year</span>
						</div>
						<p class="text-white/40 mt-2 text-sm">Complete legal protection</p>
					</div>
					<div class="p-8">
						<div class="space-y-4">
						...
						<div class="mt-8 text-center">
							<a href="#apply" class="inline-block w-full bg-king-blue hover:bg-king-blue-dark text-white py-3.5 rounded-lg font-bold transition-all text-base">
								Apply for Fortress
							</a>
						</div>
					</div>
				...
				<!-- Fortress Elite Tier -->
				<div class="rounded-3xl border-2 border-gold overflow-hidden relative depth-card">
					<div class="absolute -top-0.5 left-1/2 -translate-x-1/2 bg-gold text-king-blue px-5 py-1 rounded-b-lg text-xs font-bold tracking-wide uppercase z-10">
						Most Popular
					</div>
					<div class="bg-king-blue-dark p-8 text-center">
						<p class="text-gold uppercase tracking-widest text-xs mb-2">Fortress Elite</p>
						<div class="flex items-baseline justify-center gap-2">
							<span class="text-white font-title text-4xl md:text-5xl">$37,000</span>
							<span class="text-white/50 text-lg">/year</span>
						</div>
					...
					<div class="bg-gray-50 p-8">
						...
						<div class="text-center">
							<a href="#apply" class="inline-block w-full bg-gold hover:bg-gold-light text-king-blue py-3.5 rounded-lg font-bold transition-all transform hover:scale-[1.02] shadow-lg hover:shadow-gold/30 text-base">
								Apply for Fortress Elite
							</a>
						</div>
					</div>
				</div>
	...
	<section class="py-24 bg-king-blue">
		<div class="max-w-4xl mx-auto px-6 lg:px-8 text-center">
			...
			<blockquote class="font-title text-3xl md:text-4xl text-white leading-relaxed mb-8">
				I have multiple advisors but nobody is accountable for the whole.
			</blockquote>
			<p class="text-white/40 mb-4">— The #1 pain point reported by high-net-worth individuals</p>
			<p class="text-white/60 text-lg max-w-2xl mx-auto leading-relaxed mt-8">
				The Fortress Package eliminates that problem entirely. One firm. One attorney. One strategy that spans every matter, every asset, and every risk in your life.
			</p>
		</div>
	</section>
	...
	<section class="py-24 bg-white">
		<div class="max-w-5xl mx-auto px-6 lg:px-8">
			...
			<div class="grid md:grid-cols-3 gap-4 md:gap-8 max-w-5xl mx-auto items-stretch">
				...
				<!-- With Fortress -->
				<div class="bg-king-blue rounded-2xl p-6 md:p-9 border border-king-blue depth-card-dark">
					<h3 class="font-title text-xl text-white mb-6">Fortress</h3>
					<div class="space-y-3 mb-8 text-sm">
						<div class="flex justify-between text-white/70">
							<span>Legal audit + Risk Map</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>72-hour Evidence Bank</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>Monthly legal counsel</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
						...
						<div class="flex justify-between text-white/70">
							<span>Pre-trial preparation</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>One trial</span>
					...
					<div class="border-t border-white/20 pt-4">
						<div class="flex justify-between">
							<span class="font-semibold text-white text-sm">Annual total</span>
							<span class="font-bold text-gold">$20,000</span>
						</div>
						<p class="text-white/40 text-xs mt-2">Predictable. Coordinated. Complete.</p>
					</div>
				</div>

				<!-- With Fortress Elite -->
				<div class="bg-king-blue-dark rounded-2xl p-6 md:p-9 border-2 border-gold depth-card-dark">
					<div class="inline-block bg-gold text-king-blue px-4 py-1 rounded-full text-xs font-bold mb-4">
						BEST VALUE
					</div>
					<h3 class="font-title text-xl text-white mb-6">Fortress Elite</h3>
					<div class="space-y-3 mb-8 text-sm">
						<div class="flex justify-between text-white/70">
							<span>All Fortress services</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>Strategy Suite access</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>Reservable study rooms</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
							<span>Printing & business svcs</span>
							<span class="text-gold font-semibold">Included</span>
						</div>
						<div class="flex justify-between text-white/70">
					...
					<div class="border-t border-white/20 pt-4">
						<div class="flex justify-between">
							<span class="font-semibold text-white text-sm">Annual total</span>
							<span class="font-bold text-gold">$37,000</span>
						</div>
						<p class="text-white/40 text-xs mt-2">Complete protection + your own workspace.</p>
					</div>
				</div>
			</div>
		</div>
	...
	<!-- Application Form -->
	<section id="apply" class="py-24 bg-king-blue">
		<div class="max-w-4xl mx-auto px-6 lg:px-8">
			<div class="text-center mb-12">
				<p class="text-gold uppercase tracking-[0.3em] text-sm mb-4">Get Started</p>
				<h2 class="font-title text-4xl md:text-5xl text-white mb-4">Apply for the King's Fortress</h2>
				<p class="text-white/50 text-lg max-w-2xl mx-auto">
					Enrollment is limited. Complete the form below and we'll schedule a confidential conversation within 24 hours to discuss whether Fortress is the right fit.
				</p>
			</div>

			<div class="max-w-xl mx-auto">
				<div class="bg-white/8 backdrop-blur-sm border border-white/10 rounded-2xl p-5 md:p-8 depth-card-dark">
					{#if formStatus === 'success'}
						<div class="text-center py-8">
							<div class="text-gold text-5xl mb-4">&#10003;</div>
							<h3 class="font-title text-2xl text-white mb-2">Application Received</h3>
							<p class="text-white/50">We'll be in touch within 24 hours to schedule your confidential consultation.</p>
							<button
								type="button"
								onclick={() => formStatus = 'idle'}
								class="mt-6 text-gold hover:text-gold-light font-medium"
							>
								Submit Another Application
							</button>
						</div>
					{:else}
						<form class="space-y-5" onsubmit={handleApply}>
							<div class="grid sm:grid-cols-2 gap-4">
								<div>
									...
									<input
										...
										name="firstName"
										required
										class="w-full px-4 py-3 rounded-lg border border-white/20 bg-white/5 text-white placeholder-white/30 focus:border-gold focus:ring-2 focus:ring-gold/20 transition-all depth-inset"
										placeholder="John"
									/>
								</div>
								<div>
							...
							<div>
								<label for="phone" class="block text-sm font-medium text-white/70 mb-1">Phone</label>
								<input
									type="tel"
									id="phone"
									name="phone"
							...
							<div>
								<label for="message" class="block text-sm font-medium text-white/70 mb-1">Tell us about your situation <span class="text-white/30">(optional)</span></label>
								<textarea
									id="message"
									name="message"
									rows="4"
									class="w-full px-4 py-3 rounded-lg border border-white/20 bg-white/5 text-white placeholder-white/30 focus:border-gold focus:ring-2 focus:ring-gold/20 transition-all resize-none depth-inset"
									placeholder="Briefly describe the legal matters you're currently managing or anticipate..."
								></textarea>
							</div>
							<button
								type="submit"
								disabled={formStatus === 'submitting'}
								class="w-full bg-gold hover:bg-gold-light text-king-blue py-4 rounded-lg font-bold transition-all duration-200 disabled:opacity-60 disabled:cursor-not-allowed text-lg depth-gold"
							>
								{formStatus === 'submitting' ? 'Submitting...' : 'Apply for Fortress Membership'}
							</button>
							...
							<p class="text-xs text-white/30 text-center">
								Your information is completely confidential. By submitting, you agree to our privacy policy.
							</p>
						</form>
					{/if}
				</div>
...
<style>
	.fortress-pattern {
		background-image: url("data:image/svg+xml,%3Csvg width='60' height='60' viewBox='0 0 60 60' xmlns='http://www.w3.org/2000/svg'%3E%3Cg fill='none' fill-rule='evenodd'%3E%3Cg fill='%23F2B022' fill-opacity='1'%3E%3Cpath d='M36 34v-4h-2v4h-4v2h4v4h2v-4h4v-2h-4zm0-30V0h-2v4h-4v2h4v4h2V6h4V4h-4zM6 34v-4H4v4H0v2h4v4h2v-4h4v-2H6zM6 4V0H4v4H0v2h4v4h2V6h4V4H6z'/%3E%3C/g%3E%3C/g%3E%3C/svg%3E");
	}
</style>
