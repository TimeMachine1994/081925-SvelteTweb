								...
								<div class="flex-1">
									...
									<div class="text-sm text-muted-foreground">
										...
										{#if caseItem.client.email}
											• <a href="mailto:{caseItem.client.email}" class="text-gold hover:underline">{caseItem.client.email}</a>
										{/if}
										{#if caseItem.client.phoneNumber}
											• <a href="tel:{caseItem.client.phoneNumber}" class="text-gold hover:underline">{caseItem.client.phoneNumber}</a>
										{/if}
									</div>
								</div>
		...
		<div class="grid grid-cols-1 lg:grid-cols-2 gap-8">
			...
			<div>
				<div class="flex items-center justify-between mb-4">
					...
					<button class="px-4 py-2 bg-gold text-black rounded-lg hover:bg-gold-dark transition-colors font-semibold text-sm">
						+ Upload
					</button>
				</div>
