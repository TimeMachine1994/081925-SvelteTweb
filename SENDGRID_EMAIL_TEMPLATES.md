# Tributestream SendGrid Dynamic Email Templates

Copy and paste these HTML templates into SendGrid's Code Editor for each dynamic template.
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
            ...
            <p style="color: #666; line-height: 1.6; font-size: 14px;">
                <strong>Important:</strong> We recommend changing your password after you log in for the first time.
            </p>
...
**Template ID Variable**: `SENDGRID_TEMPLATE_BASIC_REGISTRATION`
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{invitationUrl}}" style="background: linear-gradient(135deg, #D5BA7F 0%, #E5CA8F 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block;">
                    Accept Invitation
                </a>
            </div>
...
**Template ID Variable**: `SENDGRID_TEMPLATE_EMAIL_CHANGE`
...
<body style="margin: 0; padding: 0; font-family: Arial, sans-serif; background-color: #f5f5f5;">
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="text-align: center; margin: 30px 0;">
                <a href="{{confirmationUrl}}" style="background: linear-gradient(135deg, #D5BA7F 0%, #E5CA8F 100%); color: white; padding: 15px 30px; text-decoration: none; border-radius: 8px; font-weight: bold; display: inline-block; box-shadow: 0 4px 6px rgba(0,0,0,0.1);">
            ...
            <p style="color: #666; line-height: 1.6; font-size: 14px;">
                ...
                <a href="{{confirmationUrl}}" style="color: #D5BA7F; word-break: break-all;">{{confirmationUrl}}</a>
            </p>
        </div>
...
**Template ID Variable**: `SENDGRID_TEMPLATE_PAYMENT_CONFIRMATION`
...
## 6. Payment Action Required Email

**Template ID Variable**: `SENDGRID_TEMPLATE_PAYMENT_ACTION`
        ...
        <div style="padding: 30px;">
            ...
            <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #0ea5e9;">
                ...
                <div style="text-align: center; margin: 20px 0;">
                    <a href="{{nextActionUrl}}" style="background: #f59e0b; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">
...
**Template ID Variable**: `SENDGRID_TEMPLATE_PAYMENT_FAILURE`
    ...
    <div style="max-width: 600px; margin: 0 auto; background-color: #ffffff;">
        ...
        <div style="padding: 30px;">
            ...
            <div style="background: #f0f9ff; padding: 20px; border-radius: 8px; margin: 20px 0; border-left: 4px solid #0ea5e9;">
                ...
                <div style="text-align: center; margin: 20px 0;">
                    <a href="{{retryUrl}}" style="background: #f59e0b; color: white; padding: 12px 24px; text-decoration: none; border-radius: 6px; font-weight: bold; display: inline-block;">
                        Retry Payment
                    </a>
                </div>
            </div>
...
**Template ID Variable**: `SENDGRID_TEMPLATE_CONTACT_SUPPORT`
...
**Template ID Variable**: `SENDGRID_TEMPLATE_CONTACT_CONFIRMATION`
...
1. **Create each template in SendGrid**:
   - Go to https://mc.sendgrid.com/dynamic-templates
   - Click "Create a Dynamic Template"
   - Use the template names and subjects listed above
   - Paste the HTML code into the Code Editor
   - Save and note the template ID (starts with `d-`)

2. **Add template IDs to your `.env` file**:
   ```env
   SENDGRID_TEMPLATE_ENHANCED_REGISTRATION=d-your-actual-id-1
   SENDGRID_TEMPLATE_BASIC_REGISTRATION=d-your-actual-id-2
   # ... etc for all 9 templates
   ```

3. **Test each template** using SendGrid's test send feature before going live.

All templates use your Tributestream brand colors (#D5BA7F gold) and are mobile-responsive!
