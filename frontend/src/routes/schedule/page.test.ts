...
describe('Schedule Page Calculator', () => {
  ...
  it('loads saved form data from localStorage', () => {
    ...
    const savedData = {
      ...
      addons: { photography: true, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 1 },
...
describe('Schedule Page Reactive Calculations', () => {
  it('calculates booking items correctly', () => {
    ...
    const addons = { photography: true, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 1 };
