...
export const PUT: RequestHandler = async ({ params, request, locals }) => {
	...
	try {
		...
		const messageData = await getMemorialChatMessage(memorialId, chatId);
		...
		// Update message
		await editMemorialChatMessage(memorialId, chatId, trimmedMessage);
...
export const DELETE: RequestHandler = async ({ params, locals }) => {
	...
	try {
		...
		await softDeleteMemorialChatMessage(memorialId, chatId);
