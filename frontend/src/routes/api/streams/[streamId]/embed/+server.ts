...
export const GET: RequestHandler = async ({ params }) => {
	...
	try {
		...
		console.error('❌ [EMBED_API] Error message:', err instanceof Error ? err.message : 'Unknown error');
		console.error('❌ [EMBED_API] Error stack:', err instanceof Error ? err.stack : 'No stack trace');
