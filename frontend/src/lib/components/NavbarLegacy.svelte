<script lang="ts">
	...
	// Legacy-focused navigation items
	const navigationItems = [
		{ label: 'For Families', href: '/legacy/for-families', icon: Heart },
		{ label: 'For Funeral Directors', href: '/legacy/for-funeral-directors', icon: Users },
		{ label: 'Resources', href: '/legacy/resources', icon: BookOpen },
		{ label: 'Contact', href: '/legacy/contact', icon: Mail }
	];
</script>
