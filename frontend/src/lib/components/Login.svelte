		...
		<div class="login-card">
				...
				<div class="logo-section">
					<div class="logo-icon">
						{#if showPasswordReset}
							<ArrowLeft class="h-8 w-8 text-white" />
						{:else}
			...
			{#if showPasswordReset}
				...
				<form onsubmit={handlePasswordReset} class="login-form">
					...
					<!-- Back to Login -->
					<button type="button" class="back-btn" onclick={hideResetForm}>
			...
			{:else}
				...
				<form onsubmit={handleSubmit} class="login-form">
					...
					<div class="forgot-password">
						<button type="button" class="forgot-password-btn" onclick={showResetForm}>
					...
					<!-- Google Sign In -->
					<button type="button" class="google-btn" onclick={handleGoogleSignIn} disabled={loading}>
