...
describe('Calculator Component', () => {
  ...
  it('calculates overage charges correctly', () => {
    ...
    const testFormData: CalculatorFormData = {
      ...
      additionalLocation: { enabled: false, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 },
      additionalDay: { enabled: false, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 },
      funeralDirectorName: '',
      funeralHome: '',
      addons: { photography: false, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 0 }
    };
  ...
  it('calculates USB drive pricing correctly for non-legacy tiers', () => {
    const testAddons = { photography: false, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 3 };
...
describe('Calculator Logic Functions', () => {
  ...
  const ADDON_PRICES = { photography: 400, audioVisualSupport: 200, liveMusician: 500, woodenUsbDrives: 300 };
  ...
  it('calculates solo tier correctly', () => {
    const formData: CalculatorFormData = {
      lovedOneName: 'Test',
      mainService: { location: { name: '', address: '', isUnknown: false }, time: { date: null, time: null, isUnknown: false }, hours: 2 },
      additionalLocation: { enabled: false, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 },
      additionalDay: { enabled: false, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 },
      funeralDirectorName: '', funeralHome: '',
      addons: { photography: false, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 0 }
    };
  ...
  it('calculates complex scenario correctly', () => {
    const formData: CalculatorFormData = {
      lovedOneName: 'Test',
      mainService: { location: { name: '', address: '', isUnknown: false }, time: { date: null, time: null, isUnknown: false }, hours: 4 }, // 2 hours overage
      additionalLocation: { enabled: true, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 3 }, // 1 hour overage
      additionalDay: { enabled: true, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 }, // no overage
      funeralDirectorName: '', funeralHome: '',
      addons: { photography: true, audioVisualSupport: true, liveMusician: false, woodenUsbDrives: 2 }
    };
  ...
  it('handles legacy tier USB drives correctly', () => {
    const formData: CalculatorFormData = {
      ...
      additionalDay: { enabled: false, location: { name: '', address: '', isUnknown: false }, startTime: null, hours: 2 },
      funeralDirectorName: '', funeralHome: '',
      addons: { photography: false, audioVisualSupport: false, liveMusician: false, woodenUsbDrives: 3 }
    };
